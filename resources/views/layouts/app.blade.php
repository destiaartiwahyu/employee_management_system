                ...
                <div class="sidebar">
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <!-- Main Menu -->
                            <li class="{{ request()->routeIs(['home', 'divisions', 'positions', 'position-users']) ? 'nav-item has-treeview menu-open' : 'nav-item' }}">
                                <a href="#" class="{{ request()->routeIs(['home', 'divisions', 'positions', 'position-users']) ? 'nav-link active' : 'nav-link' }}">
